// src/features/admin/components/register-admin/AdminAccountInfoStep.tsx
...
interface AdminAccountInfoStepProps {
  form: UseFormReturn<RegisterAdminFormData>;
}

export const AdminAccountInfoStep = ({ form }: AdminAccountInfoStepProps) => {
    ...
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Datos básicos para crear la cuenta del administrador
        </p>
      </div>
